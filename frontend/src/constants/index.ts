...
export const SIDEBAR_ITEMS: NavItem[] = [
  ...
  { key: 'cloud',         label: 'Cloud Readiness', icon: 'Cloud',           route: ROUTES.PROJECT_CLOUD },
  { key: 'scalability',   label: 'Scalability Assessment', icon: 'TrendingUp',  route: ROUTES.PROJECT_SCALABILITY },
