...
const MOCK_PATCHES = [
  {
    id: 'patch-1',
    title: 'Parametrize Search Query Handler',
    issue: 'SQL Injection Vulnerability in Search Handler',
...
+  const results = await db.raw(query, [\`%\${q}%\`]);
  ...
  },
  {
    ...
    issue: 'Outdated Dependency: lodash@4.17.15',
