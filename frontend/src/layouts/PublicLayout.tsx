...
export function PublicLayout() {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      {/* Minimal header */}
      <header className="fixed top-0 left-0 right-0 z-navbar h-[60px] glass-nav border-b border-border flex items-center justify-between px-6">
      ...
      {/* Page content */}
      <main className="flex-1 pt-[60px] overflow-hidden" role="main">
